        ...
        <div className='w-full md:h-[432px] flex flex-col md:flex-row gap-4'>
          ...
          <div className='w-full md:w-1/2 h-full bg-[#fefefe] p-2 flex gap-2 md:gap-0 flex-col justify-between rounded-[8px]'>
            ...
            <textarea 
              ...
              rows={10}
            ></textarea>
            <button style={{background: "linear-gradient(360deg, #FF9501 0%, #E57B00 100%)"}} className='capitalize h-[34px] w-[140px] rounded-[4px] text-white font-bold flex justify-center items-center'>
              send message
            </button>
          </div>
        </div>
